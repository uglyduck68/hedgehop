...
CLocationDlg::CLocationDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CLocationDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CLocationDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CLocationDlg::OnBnClickedButton1)
	ON_WM_NCDESTROY()
END_MESSAGE_MAP()


// CLocationDlg 메시지 처리기
...
void CLocationDlg::OnBnClickedButton1()
{
	Mgr.Send3000();
}


void CLocationDlg::OnNcDestroy()
{

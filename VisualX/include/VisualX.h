...
protected:
	...
	*/
	...
	// intro
	///////////////////////////////////////////////////////////////////////////
	Ogre::SceneNode*		m_snIntroTarget;
...
//	std::deque<SceneNode*>	m_IntroTargetList;
	...
	void ControlCameraDistance(Ogre::Camera* pCamera, Ogre::Entity* pEntity)
	{
		...
		Ogre::Real	min_x =	1.0, max_x = 0.0, min_y = 1.0, max_y = 0.0, min_dim = 1.0, max_dim = 0.0;
		...
		for( int i = 0 ; i < 7; i++ )
		{
			...
			Ogre::Real	x		= screenCorner.x / screenCorner.z + 0.5;
			Ogre::Real	y		= screenCorner.y / screenCorner.z + 0.5;
		...
		Ogre::Real	width	= (max_x - min_x);
		Ogre::Real	height	= (max_y - min_y);
		Ogre::Real	longdimension;
		...
		{
			Ogre::Real	d	= (longdimension - 0.9) * 200.0;
		...
		{
			Ogre::Real	d	= (1-(0.8/longdimension)) * 10.0;
	...
	*/
	void SetNextIntroTarget()
	{
		...
		if( m_listTarget.size() > 0 && m_nIntroCurIndex < m_listTarget.size() )
		{
			...
			////////////////////////////////////////////////////////////////////////////
			Ogre::Entity*	pTemp		= static_cast<Ogre::Entity*>(m_snIntroTarget->getAttachedObject(0));

...
bool BaseApplication::configure(void)
{
    ...
    if(mRoot->showConfigDialog())
    {
        ...
        mWindow = mRoot->initialise(true, "Battlefield Visualization");
...
void BaseApplication::chooseSceneManager(void)
{
    ...
    mSceneMgr = mRoot->createSceneManager(Ogre::ST_EXTERIOR_CLOSE/*ST_GENERIC*/);
...
void BaseApplication::createFrameListener(void)
{
	...
	// sean, add to control the access mode of keyboard and mouse
	...
	/** create buffered keyboard and mouse */
	...
	*/
	...
	// sean, add, I don't need anythings
	mTrayMgr->hideAll();
...
void BaseApplication::createViewports(void)
{
	...
	// sean, change the size and position of viewport
//    Ogre::Viewport* vp = mWindow->addViewport(mCamera);

	// make left-lower viewport on main windows 
    Ogre::Viewport* vp = mWindow->addViewport(mCamera/*, 0, 0, 0.7, 0.2, 0.2*/);

...
P4VOID HandleReconnect ANSI_ARGS((int, int, char *));
...
int rm_restart ANSI_ARGS(( ));
P4VOID ReConnectToMaster ANSI_ARGS((int, int, int, int, int *));
P4VOID re_receive_proc_table ANSI_ARGS((int));

P4VOID p4_RollbackActions ANSI_ARGS(( ));
P4BOOL p4_DeadConnection ANSI_ARGS((int));

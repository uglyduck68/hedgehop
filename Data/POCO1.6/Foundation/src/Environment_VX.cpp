...
std::string EnvironmentImpl::runtimeName;		//@ added by <uglyduck68@gmail.com>
std::string EnvironmentImpl::runtimeVersion;	//@ added by <uglyduck68@gmail.com>

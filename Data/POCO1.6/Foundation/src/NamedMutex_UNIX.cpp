...
#include <sys/stat.h>
#include <errno.h>
#if defined(sun) || defined(__APPLE__) || defined(__osf__) || defined(_AIX) || defined(POCO_VXWORKS)
#include <semaphore.h>
#else
#include <unistd.h>
#include <sys/types.h>
...
#if defined(sun) || defined(__APPLE__) || defined(__osf__) || defined(__QNX__) || defined(_AIX) || defined(POCO_VXWORKS)

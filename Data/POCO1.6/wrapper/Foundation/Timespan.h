#ifndef X1_Timespan_INCLUDED
#define X1_Timespan_INCLUDED


#include "../../Foundation/include/Poco/Timespan.h"

namespace X1 {


class Timespan : public Poco::Timespan
{
public:
	...
	Timespan(TimeDiff microseconds) : Poco::Timespan(microseconds)
	{}
	
	Timespan(long seconds, long microseconds) : Poco::Timespan(seconds , microseconds)
	{}
	
	Timespan(int days, int hours, int minutes, int seconds, int microSeconds) 
		: Poco::Timespan(days, hours, minutes, seconds, microSeconds)
	{}

	Timespan(const Timespan& timespan) : Poco::Timespan(timespan)
	{}

	Timespan(const Poco::Timespan& timespan) : Poco::Timespan(timespan)
	{}

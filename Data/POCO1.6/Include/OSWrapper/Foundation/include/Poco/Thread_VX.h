...
#if	!(VXWORKS_VERSION_MAJOR >= 6 and VXWORKS_VERSION_MINOR >= 8)	//@
...
public:	
	...
	static int getMinOSPriorityImpl(int policy = 0);	//@ make default variable
	static int getMaxOSPriorityImpl(int policy = 0);	//@ make default variable

// SimpleThreader.cpp : 콘솔 응용 프로그램에 대한 진입점을 정의합니다.
//
...
public:
	...
	// why call base class's ctor explicitly
...
public:
	...
	/**
	 * OpenThreads::Thread::start()/startThread() -> StartThread -> run
	 */
    virtual void run() {

...
This shows just one of many possible solutions.  You could pass a 
structure, you could pass a single integer which encoded i and j,
you could use a global array, you could make it a producer/consumer
program, etc.
...
/*
cc -o matrix_solution matrix_solution.c -L. -R. -g -lpthread -lthread -pthread -lposix4
*/

...
/*
  ...
  The second semaphore prevents the list from getting
  infinitely long.
...
/*
cc -o one_queue_solution one_queue_solution.c -L. -R. -g -lpthread -lthread -pthread_extensions -lposix4
*/
...
{int i;
 ...
 SEM_INIT(&requests_slots, NULL, 10);

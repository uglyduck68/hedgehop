...
/*
cc -o test_rrwlock test_rrwlock.c -L. -R. -g -lpthread -lthread -lthread_extensions -lposix4
*/
...
{int                    i;
 ...
 thread_rrwlock_init(&m, NULL);

 PTHREAD_ATTR_INIT(&attr);
 pthread_attr_setdetachstate(&attr, PTHREAD_CREATE_DETACHED);
 pthread_attr_setscope(&attr, PTHREAD_SCOPE_SYSTEM);

 PTHREAD_CREATE(&tid, &attr, recursive_wr, (void *) 5);
 PTHREAD_CREATE(&tid, &attr, recursive_wr, (void *) 5);
 PTHREAD_CREATE(&tid, &attr, recursive_wr, (void *) 5);

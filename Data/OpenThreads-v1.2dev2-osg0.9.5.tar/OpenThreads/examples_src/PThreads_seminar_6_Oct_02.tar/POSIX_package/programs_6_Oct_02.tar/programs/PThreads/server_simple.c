...
/*
  ...
  This version is unthreaded and very slow if there is any I/O delay
  simulated.

  On most errors this programs just aborts.
...
/*
cc -o serve_simpler server_simple.c -L. -R. -g -lpthread  -lthread_extensions -lposix4 -lnsl -lsocket
*/

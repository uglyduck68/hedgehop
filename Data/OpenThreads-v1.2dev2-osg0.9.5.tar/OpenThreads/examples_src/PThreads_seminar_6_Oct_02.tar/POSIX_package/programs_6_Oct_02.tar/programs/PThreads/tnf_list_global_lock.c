...
/*
cc -o tnf_list_global_lock tnf_list_global_lock.c -L. -R. -g -lpthread  -lthread_extensions -lposix4
*/
...
sem_t                   barrier;
pthread_mutex_t         people_lock = PTHREAD_MUTEX_INITIALIZER;
person_t                        people;

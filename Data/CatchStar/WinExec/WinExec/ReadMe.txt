================================================================================
    MFC 라이브러리 : WinExec 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 WinExec 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 WinExec 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
WinExec.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CWinExecApp 응용 프로그램
    클래스를 선언합니다.

WinExec.cpp
    응용 프로그램 클래스 CWinExecApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\WinExec.ico
    ...
    주 리소스 파일인 WinExec.rc에 의해 포함됩니다.
...
WinExecDlg.h, WinExecDlg.cpp - 대화 상자
    이 파일에는 CWinExecDlg 클래스가 들어 있습니다. 이 클래스는
    응용 프로그램의 주 대화 상자 동작을 정의합니다. 대화 상자의 템플릿은
    Microsoft Visual C++에서 편집할 수 있는 WinExec.rc에 있습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 WinExec.pch와

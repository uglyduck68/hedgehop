...
Ogre::Vector3 SceneNodeOffset::GetScaleOffset() const {
	return this->ScaleOffset;
}
Ogre::Vector3 SceneNodeOffset::GetPositionOffset() const {
	return this->PositionOffset;
}
Ogre::Degree SceneNodeOffset::GetRollOffset() const {
	return this->RollOffset;
}
Ogre::Degree SceneNodeOffset::GetPitchOffset() const {
	return this->PitchOffset;
}
Ogre::Degree SceneNodeOffset::GetYawOffset() const {
	return this->YawOffset;
}
void SceneNodeOffset::SetScaleOffset( Ogre::Vector3 ScaleOffset ) {
	this->ScaleOffset = ScaleOffset;
}
void SceneNodeOffset::SetPositionOffset( Ogre::Vector3 PositionOffset ) {
	this->PositionOffset = PositionOffset;
}
void SceneNodeOffset::SetRollOffset( Ogre::Degree value ) {
	this->RollOffset = value;
}
void SceneNodeOffset::SetPitchOffset( Ogre::Degree value ) {
	this->PitchOffset = value;
}
void SceneNodeOffset::SetYawOffset( Ogre::Degree value ) {
	this->YawOffset = value;
}
// Accessors, Transforming Space, default is TS_PARENT
Ogre::Node::TransformSpace SceneNodeOffset::GetTransformSpace() {
	return this->TS;
}
void SceneNodeOffset::SetTransformSpace( Ogre::Node::TransformSpace TS ) {
	this->TS = TS;
}
// Operators

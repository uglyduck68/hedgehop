...
StringConverter::StringConverter( wxString InputForm_wx_str ) {
	this->mStr = new wxString( InputForm_wx_str );
}
...
const char* StringConverter::toCString() const {
...
wxString StringConverter::toWxString() const {
	return wxString( *( this->mStr ));
}
